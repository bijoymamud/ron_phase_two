...
const Verify_OTP = () => {
  ...
  const [otpVerification, { isLoading: isOtpLoading }] =
  ...
  return (
    <section className="min-h-screen">
      <div className="flex items-center">
        ...
        <div className="basis-8/12 bg-white dark:bg-white h-screen flex flex-col justify-center items-center">
          <form
            onSubmit={handleSubmit(onSubmit)}
            className="text-[#0A3161] md:p-8 rounded-lg w-full md:max-w-lg"
          >
            <h2 className="md:text-4xl text-3xl font-bold mb-2 text-start">
              Verify OTP
            </h2>
            ...
            <button
              type="submit"
              className="w-full uppercase p-3 bg-[#B31942] text-white rounded-lg font-semibold hover:bg-[#af2a4d] transition flex items-center justify-center"
              disabled={isLoading}
            >
              {isLoading ? (
            ...
            <p className="mt-4 text-[#0A3161] text-end">
              ...
              <span
                ...
                className="text-[#B31942] font-semibold cursor-pointer"
              >
                Resend
              </span>
            </p>
