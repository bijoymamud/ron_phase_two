...
const Auto_Narative = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="min-h-screen text-white flex justify-center items-center p-2 md:p-6"
       style={{ 
        backgroundImage: 'url("https://i.ibb.co/Y7Z6tdQk/Frame-1597884882-1.png")', 
