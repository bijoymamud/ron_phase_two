...
//   return (
//     <div className="flex flex-col items-center justify-center md:min-h-screen min-h-[85vh] dark:bg-white pt-14 pb-10 p-4 md:max-w-4xl mx-auto md:pt-32">
//       {/* Header */}
...
//             })}
//             className={`mt-1 block w-full p-2  dark:bg-white dark:border-black dark:text-black border border-gray-300 uppercase rounded-md  text-sm text-gray-700 ${
...
//               required: "This field is required",
//             })}
//             className={`mt-1 block w-full p-2 dark:bg-white uppercase dark:border-black dark:text-black border border-gray-300 rounded-md  text-sm text-gray-700 ${
...
//               required: "This field is required",
//             })}
//             className={`mt-1 block w-full p-2 border dark:bg-white dark:border-black dark:text-black uppercase border-gray-300 rounded-md  text-sm text-gray-700 h-32 resize-none ${
...
const SinusitisForm = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center md:min-h-screen min-h-[85vh] bg-white dark:bg-white pt-14 pb-10 p-4  mx-auto md:pt-32">
      ...
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="w-full bg-white dark:bg-white max-w-4xl p-5"
      >
        {/* Runny Nose */}
        <div className="mb-6">
