...
// const BASE_URL = "http://10.10.13.73:4000";
...
//   return (
//     <div className="min-h-screen py-20 pt-24 md:pt-32 px-4 flex flex-col items-center w-full bg-white dark:bg-white">
...
//               >
//                 <td className="py-3 px-2 md:px-4 hidden md:table-cell text-black dark:text-black">
//                   {startIndex + index + 1}
//                 </td>
//                 <td className="py-3 px-2 md:px-4 text-black dark:text-black">
...
//                   })}
//                 </td>
//                 <td className="py-3 px-2 md:px-4 capitalize text-black dark:text-black">
//                   {pdf.status}
//                 </td>
...
const VAForm = memo(() => {
  ...
  return (
    <div className="min-h-screen py-20 pt-24 md:pt-32 px-4 flex flex-col items-center w-full bg-white">
      <h2 className="text-3xl md:text-4xl font-semibold mb-6 text-gray-800">
        VA Form PDFs
      </h2>
