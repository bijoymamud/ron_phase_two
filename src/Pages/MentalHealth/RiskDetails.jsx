      ...
      <div className="md:p-6 p-2 rounded-lg w-full max-w-4xl flex flex-col justify-between">
        ...
        >
          ...
          <label className="block text-sm font-medium text-gray-700">
            ...
            Your Job?
            <select
              {...register("livesAtRisk", {
                required: "This field is required",
              })}
              className={`mt-1 block w-full p-2 border border-gray-300 dark:bg-white dark:border-black dark:text-black uppercase rounded-md  text-sm ${errors.livesAtRisk ? "border-red-500" : ""}`}
              defaultValue=""
            >
            ...
            <>
              ...
              <label className="block text-sm font-medium text-gray-700">
                ...
                <input
                  ...
                  type="date"
                  className={`mt-1 block w-full p-2 dark:bg-white dark:border-black dark:text-black border border-gray-300 uppercase rounded-md text-sm [appearance:auto] [&::-webkit-calendar-picker-indicator]:bg-transparent [&::-webkit-calendar-picker-indicator]:cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-100 dark:[&::-webkit-calendar-picker-indicator]:invert ${errors.jobAssignmentDates ? "border-red-500" : ""}`}
                />
                {errors.jobAssignmentDates && (
                  <span className="text-red-500 text-sm">
                    {errors.jobAssignmentDates.message}
                  </span>
                )}
              </label>
              ...
              <label className="block text-sm font-medium text-gray-700">
                ...
                <select
                  ...
                  className={`mt-1 block w-full p-2 dark:bg-white dark:border-black dark:text-black border border-gray-300 uppercase rounded-md  text-sm ${errors.riskType ? "border-red-500" : ""}`}
                  defaultValue=""
                >
                  <option value="" disabled>
                    Select risk type
                  ...
                  <option value="mechanical">
                    Mechanical Failure [E.G., Vehicle, Machinery]
                  </option>
                  <option value="environmental">
                    Environmental Hazard [E.G., Working In Extreme Conditions]
                  </option>
              ...
              <label className="block text-sm font-medium text-gray-700">
                ...
                <textarea
                  {...register("stressfulScenarios", {
                    required: "This field is required",
                  })}
                  className={`mt-1 block w-full p-2 dark:bg-white dark:border-black dark:text-black border border-gray-300 uppercase rounded-md  text-sm h-32 resize-none ${errors.stressfulScenarios ? "border-red-500" : ""}`}
                  placeholder="Enter details here..."
                />
                {errors.stressfulScenarios && (
                  <span className="text-red-500 text-sm">
                    {errors.stressfulScenarios.message}
                  </span>
                )}
              </label>
            </>
