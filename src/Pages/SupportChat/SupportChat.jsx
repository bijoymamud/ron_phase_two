...
//       setShowSubjectInput(true);
//       console.log(showSubjectInput, "lksdjlgjaljdfjsgjasdfgoijogfdoiasj line ");
//       setChatId(null);
//       setWebsocketChatId(null);
//       setMessages([]);
//       setInputMessage("");

//       console.log(ws?.readyState, "klsdfjgalj");
//       if (ws.readyState) {
//         ws.close();
//         setWebsocket(null);
//       }
...
//   // delete it
//   useEffect(() => {
//     // console.log(showSubjectInput, "lksdjlgjaljdfjsgjasdfgoijogfdoiasj");
//   }, [showSubjectInput]);
...
//                   <div
//                     className={`relative bg-white text-[#0A3161] px-4 py-2 rounded-2xl shadow-sm border border-gray-200 ${msg.optimistic ? "opacity-70" : ""}`}
//                   >
