...
// import Veterans_military_service_voice from "../../../src/cris_voice/Military_Service_Details_chris.mp3";
// import Veterans_current_status_voice from "../../../src/cris_voice/Current_Status_chris.mp3";
// import Submit_voice from "../../../src/cris_voice/Have_You_Ever_Applied_for_VA_Benefits_chris.mp3"; // Added for submit action
...
//     const audio = new Audio(Submit_voice);
//     try {
//       await audio.play();
...
//       });
//     } catch (error) {
//       console.error("Submit audio playback failed:", error);
//     } finally {
//       console.log(data);
//       localStorage.setItem("veteran_information", JSON.stringify(data));
//       navigate("/issues");
